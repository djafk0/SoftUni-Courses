...
namespace _1.Vehicles
{
    public class StartUp
    {
        static void Main(string[] args)
        {
            ...
            IVehicle car = CreateVechicle(vechicleData);

            vechicleData = ReadData();
            IVehicle truck = CreateVechicle(vechicleData);
        ...
        private static void RefuelVechicle(IVehicle car, IVehicle truck, IVehicle bus, string[] commandArgs)
        {
        ...
        private static void DriveVechicle(IVehicle car, IVehicle truck, IVehicle bus, string[] commandArgs)
        {
            string vechicleType = commandArgs[0];
        ...
        private static IVehicle CreateVechicle(string[] vechicleData)
        {
